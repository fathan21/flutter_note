...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _buildBody() {
    ...
    switch (_activemenu) {
      case "5":
        return Text(_activemenu.toString());
        break;
      case "6":
        return Text(_activemenu.toString());
        break;
...
class ListDrawer extends StatelessWidget {
    ...
    for (var item in menu) {
      list.add(
        Container(
          ...
          decoration: activeMenu == item["id"] ? activeMenuStyle : menuStyle,
          child: ListTile(
  ...
  List<Widget> listMyWidgets(context) {
    ...
    var menu = [
      {"id": "1", "label": "Catatan", "icon": Icons.book},
      {"id": "2", "label": "Pengingat", "icon": Icons.notifications},
    ];

    var menu1 = [
      {"id": "3", "label": "Arsip", "icon": Icons.archive},
      {"id": "4", "label": "Sampah", "icon": Icons.delete},
    ];

    var menu2 = [
      {"id": "5", "label": "Setelan", "icon": Icons.settings},
      {"id": "6", "label": "Bantuan & Masukan", "icon": Icons.help_outline},
    ];
    list.add(_options(
      context,
      borderBottom: 1,
